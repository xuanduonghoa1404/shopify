...
function Button({
  ...
  const childMarkup = children ? /*#__PURE__*/React__default.createElement("span", {
    className: classNames(styles$a.Text, removeUnderline && styles$a.removeUnderline) // Fixes Safari bug that doesn't re-render button text to correct color
    ,
...
function Label({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    id: labelID(id),
    htmlFor: id,
    className: classNames(styles$r.Text, requiredIndicator && styles$r.RequiredIndicator)
  }, children));
}
...
function Labelled(_ref) {
  let {
    ...
    requiredIndicator
      ...
      rest = _objectWithoutProperties(_ref, ["id", "label", "error", "action", "helpText", "children", "labelHidden", "requiredIndicator"]);
...
function TextField({
  ...
  const inputClassName = classNames(styles$v.Input, align && styles$v[variationName('Input-align', align)], suffix && styles$v['Input-suffixed'], clearButton && styles$v['Input-hasClearButton'], monospaced && styles$v.monospaced);
...
function CalloutCard({
  ...
  const containerClassName = classNames(styles$G.Container, onDismiss && styles$G.hasDismiss);
...
class ColorPicker extends React.PureComponent {
  ...
  render() {
    ...
    const className = classNames(styles$L.ColorPicker, fullWidth && styles$L.fullWidth);
    return /*#__PURE__*/React__default.createElement("div", {
      className: className,
      id: id,
    ...
    }), alphaSliderMarkup, /*#__PURE__*/React__default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }));
  }
...
const DropZone = function DropZone({
  ...
  const classes = classNames(styles$R.DropZone, outline && styles$R.hasOutline, focused && styles$R.focused, (active || dragging) && styles$R.isDragging, disabled && styles$R.isDisabled, (internalError || error) && styles$R.hasError, !variableHeight && styles$R[variationName('size', size)], measuring && styles$R.measuring);
  ...
  }, dragOverlay, dragErrorOverlay, /*#__PURE__*/React__default.createElement(VisuallyHidden, null, /*#__PURE__*/React__default.createElement(DropZoneInput, Object.assign({}, inputAttributes, {
  ...
  function overlayMarkup(icon, color, text) {
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      vertical: true,
      spacing: "tight"
    }, size === 'small' && /*#__PURE__*/React__default.createElement(Icon, {
      source: icon,
      color: color
...
function EmptyState({
  ...
  const withinContentContainer = React.useContext(WithinContentContext);
  const className = classNames(styles$S.EmptyState, fullWidth && styles$S.fullWidth, imageContained && styles$S.imageContained, withinContentContainer && styles$S.withinContentContainer);
...
function Sheet({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, activatorMarkup, /*#__PURE__*/React__default.createElement(Portal, {
    idPrefix: "sheet"
  }, /*#__PURE__*/React__default.createElement(reactTransitionGroup.CSSTransition, {
    nodeRef: container,
...
class FiltersInner extends React.Component {
  ...
  render() {
    ...
    const rightActionMarkup = filters.length ? /*#__PURE__*/React__default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, /*#__PURE__*/React__default.createElement(Button, {
...
function Dialog(_ref) {
  let {
    ...
    limitHeight
      ...
      props = _objectWithoutProperties(_ref, ["instant", "labelledBy", "children", "onClose", "onExited", "onEntered", "large", "small", "limitHeight"]);

  const containerNode = React.useRef(null);
  const classes = classNames(styles$12.Modal, small && styles$12.sizeSmall, large && styles$12.sizeLarge, limitHeight && styles$12.limitHeight);
...
const Modal = function Modal({
  ...
  const handleExited = React.useCallback(() => {
    ...
    const activatorElement = activator && isRef$2(activator) ? activator && activator.current : activatorRef.current;
  ...
  if (open) {
    ...
    const scrollContainerMarkup = noScroll ? /*#__PURE__*/React__default.createElement("div", {
      className: styles$17.Body
    }, body) : /*#__PURE__*/React__default.createElement(Scrollable, {
      shadow: true,
      className: styles$17.Body,
      onScrolledToBottom: onScrolledToBottom
    }, body);
  ...
  const activatorMarkup = activator && !isRef$2(activator) ? /*#__PURE__*/React__default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return /*#__PURE__*/React__default.createElement(WithinContentContext.Provider, {
    value: true
...
const Row = /*#__PURE__*/React.memo(function Row({
  ...
  const rowClassName = classNames(styles$1b.TableRow, condensed && styles$1b.condensedRow, selected && styles$1b['TableRow-selected'], subdued && styles$1b['TableRow-subdued'], hovered && styles$1b['TableRow-hovered'], status && styles$1b[variationName('status', status)]);
...
function Page(_ref) {
  let {
    ...
    divider
      ...
      rest = _objectWithoutProperties(_ref, ["children", "fullWidth", "narrowWidth", "divider"]);

  const pageClassName = classNames(styles$1n.Page, fullWidth && styles$1n.fullWidth, narrowWidth && styles$1n.narrowWidth);
  ...
  const contentClassName = classNames(styles$1n.Content, divider && hasHeaderContent && styles$1n.divider);
...
function ProgressBar({
  ...
  const i18n = useI18n();
  const className = classNames(styles$1p.ProgressBar, size && styles$1p[variationName('size', size)], color && styles$1p[variationName('color', color)]);
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: classNames(styles$1p.Indicator, animated && styles$1p.Animated),
    style: {
